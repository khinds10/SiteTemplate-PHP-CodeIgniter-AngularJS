	...
	function write_log($level = 'error', $msg, $php_error = FALSE) {
		...
		if (strtolower ( USE_SYSLOG ) == 'true') {
			switch (SYSLOG_FACILITY) {
				case 0 :
					openlog ( "PHP", LOG_PID, LOG_LOCAL0 );
					break;
				case 1 :
					openlog ( "PHP", LOG_PID, LOG_LOCAL1 );
					break;
				case 2 :
					openlog ( "PHP", LOG_PID, LOG_LOCAL2 );
					break;
				case 3 :
					openlog ( "PHP", LOG_PID, LOG_LOCAL3 );
					break;
				case 4 :
					openlog ( "PHP", LOG_PID, LOG_LOCAL4 );
					break;
				case 5 :
					openlog ( "PHP", LOG_PID, LOG_LOCAL5 );
					break;
				case 6 :
					openlog ( "PHP", LOG_PID, LOG_LOCAL6 );
					break;
				case 7 :
					openlog ( "PHP", LOG_PID, LOG_LOCAL7 );
					break;
				default :
