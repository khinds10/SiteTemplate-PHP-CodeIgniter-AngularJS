...
define('WEBSITE_PRODUCTION_URL', 'http://www.website.com');
define('WEBSITE_DESCRIPTION', 'website description here');
define('WEBSITE_TITLE', 'My Website - Title of website');
define('WEBSITE_META_VIEWPORT', 'initial-scale = 1.0');
